#this code plots a neutral curve for unstable region between alpha and Re
#shows how spurious mode are neglected using resolution method
#graph between gwrowth Rate vs. Wavenumber for Plane Poiseuille Flow
